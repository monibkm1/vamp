...
TELEGRAM_BOT_TOKEN = '7350847548:AAGKXoYdM0S0RaV8rODyFP3gdxZNvjFUZZQ'
ADMIN_USER_ID = 1232759277  
...
async def start(update: Update, context: CallbackContext):
    ...
    if not await is_user_allowed(user_id):
        ...
        return
    message = (
       "*🚀ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ ᴛʜᴇ ıllıllı BKM ɱσ∂ χ DɗoS̴ S̴ǝƦƔǝƦ ıllıllı 🚀*\n\n"
        "*💀Use /attack <ip> <port> <duration>*\n"
        "*💀ꜱᴇʀᴠᴇʀ ꜰʀᴇᴇᴢ ᴡɪᴛʜ @BKMOMNIVERSE 🚀*" 
    )
...
async def attack(update: Update, context: CallbackContext):
    ...
    text=(
        ...
        f"*🔥ᴜɴʟᴇᴀꜱʜɪɴɢ ꜰᴏʀᴄᴇ. ɴᴏ ᴛᴜʀɴɪɴɢ ʙᴀᴄᴋ. Powered by @BKMOMNIVERSE💥*"
    ), parse_mode='Markdown')
